# P2PFlow v1.7.1 — Manual Update Guide
...
`P2PFlow_v1.7.1_UNIFIED.zip` clean temporary directory-তে extract করুন। Extract করা application files production Application Root-এ copy/overwrite করুন।
...
তারপর service restart করুন। Health/System Update/Footer-এ application `1.7.1` এবং schema `37` নিশ্চিত করুন।

## 4. Browser/PWA cache

v1.7.1 routing এবং AppShell architecture বদলেছে। Deployment-এর পরে:
...
v1.7.1 database schema পরিবর্তন করে না। প্রয়োজন হলে validated previous release code pointer-এ rollback করা যায়। Rollback-এর পরে browser/CDN cache আবার purge/hard-refresh করুন, কারণ v1.7.1 asset query/version এবং routing runtime আলাদা।
