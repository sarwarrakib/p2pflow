...
`npm run build:release` পুরোনো hosting configuration থাকলে v1.2.0-এ compatibility alias হিসেবে কাজ করবে, কিন্তু নতুন configuration-এ `npm run build` ব্যবহার করুন। Signed GitHub update asset শুধু GitHub Actions-এ `npm run release:package` দিয়ে তৈরি হবে।

# P2PFlow v1.2.0 — GitHub থেকে Hosting Deploy
