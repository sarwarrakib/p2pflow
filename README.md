...
Internal SemVer: `1.7.6`
UI: `1.6`
Database schema: `37`

Normal next version: `SET_NEXT_VERSION.bat` -> `1.8.0`  
Hotfix: `SET_HOTFIX_VERSION.bat` -> `1.7.7`
...
## v1.7.6 Dedicated Frontend Architecture — Fixed AppShell & Clean History Routes
...
বিস্তারিত: `P2PFlow_v1.7.6_RELEASE_NOTES_BN.md`, `P2PFlow_v1.7.6_MANUAL_UPDATE_BN.md` এবং `P2PFlow_v1.7.6_LAUNCH_CHECKLIST_BN.md`.
