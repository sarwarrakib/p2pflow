...
Internal SemVer: `1.6.2`
UI: `1.6`
Database schema: `37`

Normal next version: `SET_NEXT_VERSION.bat` -> `1.7.0`  
Hotfix: `SET_HOTFIX_VERSION.bat` -> `1.6.3`
...
## v1.6.2 Dedicated Frontend Architecture — Fixed AppShell & Clean History Routes
...
বিস্তারিত: `P2PFlow_v1.6.2_RELEASE_NOTES_BN.md`, `P2PFlow_v1.6.2_MANUAL_UPDATE_BN.md` এবং `P2PFlow_v1.6.2_LAUNCH_CHECKLIST_BN.md`.
