# P2PFlow 1.5 - এক ফাইল Installation / Update / GitHub Guide

## A. নতুন সার্ভারে ইনস্টল

1. `P2PFlow_v1.5.37_UNIFIED.zip` Node Application Root-এ upload করুন।
...
3. একই `P2PFlow_v1.5.37_UNIFIED.zip` extract করে application files overwrite করুন।
