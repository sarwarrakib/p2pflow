# P2PFlow v1.5.18 Public Launch Checklist
...
- [ ] `P2PFlow_v1.5.18_UNIFIED.zip` এবং SHA-256 file একই trusted source থেকে নেওয়া হয়েছে।
- [ ] `sha256sum -c P2PFlow_v1.5.18_SHA256.txt` সফল।
- [ ] `unzip -t P2PFlow_v1.5.18_UNIFIED.zip` সফল।
...
- [ ] `/ready` HTTP 200, version `1.5.18`, schema `32`।
...
## 16. Accounting and profit scope
...
## 17. Mail, browser and operations
