// v1.7.1: fixed-viewport AppShell, clean History routes, persistent per-route hosts, lifecycle rendering, and data-only DOM patching.
// v1.7.1: stable-shell navigation, stale-request cancellation, non-destructive order/chat updates, and latest-navigation-wins rendering.
...
function cacheActiveRouteView() {
  // v1.7.1 keeps the entire route host intact instead of moving/recreating page
