# P2PFlow v1.5.15 Public Launch Checklist
...
- [ ] `P2PFlow_v1.5.15_UNIFIED.zip` এবং SHA-256 file একই secure source থেকে নেওয়া হয়েছে।
- [ ] `sha256sum -c P2PFlow_v1.5.15_SHA256.txt` সফল হয়েছে।
...
- [ ] `/ready` returns HTTP 200, version `1.5.15`, expected schema/revision।
