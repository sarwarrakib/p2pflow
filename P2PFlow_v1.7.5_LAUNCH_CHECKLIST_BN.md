# P2PFlow v1.7.5 — Launch Checklist
...
## v1.7.5 performance / realtime checks

- [ ] Browser realtime channel connected অবস্থায় open-chat REST fallback প্রায় 20s cadence-এ থাকে
- [ ] SSE disconnect হলে chat fallback প্রায় 3s cadence-এ আসে
- [ ] Binance chat WebSocket healthy হলে background REST chat sweep skip হয়
- [ ] WebSocket ping/pong heartbeat এবং reconnect কার্যকর
- [ ] default auto detail sync 30s এবং open detail rows 12
- [ ] Binance request scheduler queue/concurrency health endpoint-এ দৃশ্যমান
- [ ] slow request log-এ 2500ms+ request ধরা পড়ে (default threshold)
- [ ] static JS/CSS `br`/gzip response cache কার্যকর
- [ ] Extension version 6.1.9; failed CRM poll adaptive backoff করে
