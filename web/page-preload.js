...
(() => {
  ...
  const files = {
    ...
    health:'health.js', 'system-update':'system-update.js', settings:'settings.js', billing:'billing.js', 'super-admin':'super-admin.js', 'p2p-extension':'p2p-extension.js', security:'security.js', notifications:'notifications.js', audit:'audit.js'
  };
