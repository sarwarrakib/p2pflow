...
async function renderCredentials() {
  ...
  $('#content').innerHTML = `<div class="credentials-page">
    <div class="toolbar credentials-toolbar"><div class="actions"><button id="addCredBtn">Add Binance API Credential</button><button class="secondary" id="openHealthBtn">Health Check</button>${hasPerm('credentials.manage') ? '<button class="secondary" id="syncBinancePaymentMethodsBtn">Sync Payment Methods</button>' : ''}</div></div>
