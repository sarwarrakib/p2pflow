...
assert(pkg.version === '1.5.39', `expected v1.5.39, got ${pkg.version}`);
assert(server.includes('const APP_SCHEMA_VERSION = 37;'), 'schema 35 is required for transaction-specific payment rules.');
