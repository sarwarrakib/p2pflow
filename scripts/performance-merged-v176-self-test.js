...
assert(pkg.version === '1.7.7', `expected 1.7.7 before release bump, got ${pkg.version}`);
...
assert(index.includes('/page-preload.js?v=1.7.7'), 'active-route preload script is missing');
assert(!index.includes('/js/pages/orders.js?v=1.7.7') && !index.includes('/js/pages/ads.js?v=1.7.7'), 'page bundles are still eager on application boot');
