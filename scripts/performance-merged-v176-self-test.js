...
assert(pkg.version === '1.7.9', `expected 1.7.9 before release bump, got ${pkg.version}`);
...
assert(index.includes('/page-preload.js?v=1.7.9'), 'active-route preload script is missing');
assert(!index.includes('/js/pages/orders.js?v=1.7.9') && !index.includes('/js/pages/ads.js?v=1.7.9'), 'page bundles are still eager on application boot');
