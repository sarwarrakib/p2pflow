...
assert(/const APP_SCHEMA_VERSION = 36;/.test(server), 'Schema 36 is required for permission-only migration.');
...
console.log(JSON.stringify({ ok:true, permissionAuthority:'explicit-permissions-only', schema:36, adRateGuard:true, binancePayloadLeak:false }));
