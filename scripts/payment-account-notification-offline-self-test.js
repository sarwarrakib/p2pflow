...
assert(pkg.version === '1.5.26', `expected 1.5.26, got ${pkg.version}`);
...
assert(index.includes('/js/pages/offline-transactions.js?v=1.5.26'), 'Offline page script not loaded.');
