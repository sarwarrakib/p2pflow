...
assert(pkg.version === '1.5.18', `expected 1.5.18, got ${pkg.version}`);
...
assert(index.includes('/js/pages/offline-transactions.js?v=1.5.18'), 'Offline page script not loaded.');
