...
assert(pkg.version === '1.5.23', `expected 1.5.23, got ${pkg.version}`);
...
assert(index.includes('/js/pages/offline-transactions.js?v=1.5.23'), 'Offline page script not loaded.');
