...
assert(pkg.version === '1.5.40', `expected 1.5.40, got ${pkg.version}`);
...
assert(index.includes('/js/pages/offline-transactions.js?v=1.5.40'), 'Offline page script not loaded.');
