...
assert(pkg.version === '1.6.6', `expected 1.6.6, got ${pkg.version}`);
assert(server.includes('const APP_SCHEMA_VERSION = 39;'), 'schema 34 missing.');
...
assert(index.includes('/js/pages/offline-transactions.js?v=1.6.6'), 'Offline page script not loaded.');
