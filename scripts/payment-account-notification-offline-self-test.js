...
assert(pkg.version === '1.5.28', `expected 1.5.28, got ${pkg.version}`);
...
assert(index.includes('/js/pages/offline-transactions.js?v=1.5.28'), 'Offline page script not loaded.');
