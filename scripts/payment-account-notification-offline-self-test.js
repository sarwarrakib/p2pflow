...
assert(pkg.version === '1.5.39', `expected 1.5.39, got ${pkg.version}`);
...
assert(index.includes('/js/pages/offline-transactions.js?v=1.5.39'), 'Offline page script not loaded.');
