...
assert(pkg.version === '1.5.30', `expected 1.5.30, got ${pkg.version}`);
...
assert(index.includes('/js/pages/offline-transactions.js?v=1.5.30'), 'Offline page script not loaded.');
