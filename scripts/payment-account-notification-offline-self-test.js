...
assert(pkg.version === '1.5.29', `expected 1.5.29, got ${pkg.version}`);
...
assert(index.includes('/js/pages/offline-transactions.js?v=1.5.29'), 'Offline page script not loaded.');
