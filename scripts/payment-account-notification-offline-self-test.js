...
assert(pkg.version === '1.5.31', `expected 1.5.31, got ${pkg.version}`);
...
assert(index.includes('/js/pages/offline-transactions.js?v=1.5.31'), 'Offline page script not loaded.');
