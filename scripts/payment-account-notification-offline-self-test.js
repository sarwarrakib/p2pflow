...
assert(pkg.version === '1.8.0', `expected 1.8.0, got ${pkg.version}`);
assert(server.includes('const APP_SCHEMA_VERSION = 38;'), 'schema 34 missing.');
...
assert(index.includes('/page-preload.js?v=1.8.0') && app.includes("'offline-transactions':'offline-transactions.js'"), 'Offline page lazy module is not registered.');
