...
assert(pkg.version === '1.5.36', `expected 1.5.36, got ${pkg.version}`);
...
assert(index.includes('/js/pages/offline-transactions.js?v=1.5.36'), 'Offline page script not loaded.');
