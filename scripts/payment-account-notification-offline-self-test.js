...
assert(pkg.version === '1.5.38', `expected 1.5.38, got ${pkg.version}`);
...
assert(index.includes('/js/pages/offline-transactions.js?v=1.5.38'), 'Offline page script not loaded.');
