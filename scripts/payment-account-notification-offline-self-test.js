...
assert(pkg.version === '1.5.33', `expected 1.5.33, got ${pkg.version}`);
...
assert(index.includes('/js/pages/offline-transactions.js?v=1.5.33'), 'Offline page script not loaded.');
