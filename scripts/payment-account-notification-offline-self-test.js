...
assert(pkg.version === '1.5.27', `expected 1.5.27, got ${pkg.version}`);
...
assert(index.includes('/js/pages/offline-transactions.js?v=1.5.27'), 'Offline page script not loaded.');
