...
assert(pkg.version === '1.5.22', `expected 1.5.22, got ${pkg.version}`);
...
assert(index.includes('/js/pages/offline-transactions.js?v=1.5.22'), 'Offline page script not loaded.');
