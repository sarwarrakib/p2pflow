...
assert(pkg.version === '1.5.21', `expected 1.5.21, got ${pkg.version}`);
...
assert(index.includes('/js/pages/offline-transactions.js?v=1.5.21'), 'Offline page script not loaded.');
