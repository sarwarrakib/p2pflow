...
assert(pkg.version === '1.5.37', `expected 1.5.37, got ${pkg.version}`);
...
assert(index.includes('/js/pages/offline-transactions.js?v=1.5.37'), 'Offline page script not loaded.');
