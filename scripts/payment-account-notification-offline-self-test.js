...
assert(pkg.version === '1.5.32', `expected 1.5.32, got ${pkg.version}`);
...
assert(index.includes('/js/pages/offline-transactions.js?v=1.5.32'), 'Offline page script not loaded.');
