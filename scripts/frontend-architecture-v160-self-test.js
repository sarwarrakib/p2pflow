...
const assert = (condition, message) => { if (!condition) throw new Error(`Frontend architecture v1.6.3 self-test failed: ${message}`); };
...
console.log(JSON.stringify({
  ok:true,
  architecture:'v1.6.3-fixed-shell-history-router',
